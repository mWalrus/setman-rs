...
pub fn parse_args() -> ArgMatches<'static> {
   return App::new("Setman - Application settings manager")
        ...
        .arg(Arg::with_name("install")
            ...
            .required_unless_one(&["uninstall", "sync", "install_all", "uninstall_all", "sync_all", "new"])
            .takes_value(true))
        .arg(Arg::with_name("uninstall")
            ...
            .required_unless_one(&["install", "sync", "install_all", "uninstall_all", "sync_all", "new"])
            .takes_value(true))
        .arg(Arg::with_name("sync")
            ...
            .required_unless_one(&["install", "uninstall", "install_all", "uninstall_all", "sync_all", "new"])
            .takes_value(true))
        .arg(Arg::with_name("install_all")
            .long("install-all")
            .help("Install all applications settings")
            .required_unless_one(&["install", "uninstall", "sync", "uninstall_all", "sync_all", "new"])
            .takes_value(false))
        .arg(Arg::with_name("uninstall_all")
            .long("uninstall-all")
            .help("Uninstall all applications settings")
            .required_unless_one(&["install", "uninstall", "sync", "install_all", "sync_all", "new"])
            .takes_value(false))
        .arg(Arg::with_name("sync_all")
            .long("sync-all")
            .help("Sync all applications settings")
            .required_unless_one(&["install", "uninstall", "sync", "install_all", "uninstall_all", "new"])
            .takes_value(false))
